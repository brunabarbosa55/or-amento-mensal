...
class OrçamentoApp(MDApp):
    ...
    def calcular_orcamento(self, instance):
        try:
            ...
            # Calculando o total de gastos somando todas as categorias
            total_gastos = aluguel + alimentacao + transporte + outros

            # Comparando o total de gastos com a meta de orçamento definida
